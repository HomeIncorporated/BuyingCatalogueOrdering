namespace NHSD.BuyingCatalogue.Ordering.Api.IntegrationTests.Steps.Support
{
    internal static class ScenarioContextKeys
    {
        ...
        internal const string OrderMapDictionary = nameof(OrderMapDictionary);
        internal const string PreUpdateOrderMapDictionary = nameof(PreUpdateOrderMapDictionary);

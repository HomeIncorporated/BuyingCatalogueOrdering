...
Scenario: 1. Get an ordering party
    When the user makes a request to retrieve the ordering-party section with the Order Description Description1
...
Scenario: 2. Get an empty ordering party
    When the user makes a request to retrieve the ordering-party section with the Order Description Description2
    Then a response with status code 200 is returned

...
Background:
    ...
    Given Orders exist
        ...
        | Description1 | 4af62b99-638c-4247-875e-965239cd0c48 | Hampshire CC     | 432432              | LS 1 3AP                    | Fred.robinson@email.com  | 1             | 11/05/2020 | 11/05/2020  | 335392e4-4bb1-413b-9de5-36a85c9c0422 |
        | Description2 | 4af62b99-638c-4247-875e-965239cd0c48 | Hampshire CC     | 432432              | LS 1 3AP                    |                          | 1             | 11/05/2020 | 11/05/2020  | 335392e4-4bb1-413b-9de5-36a85c9c0422 |
    And the user is logged in with the Buyer role for organisation 4af62b99-638c-4247-875e-965239cd0c48

@4616
Scenario: 1. Get an ordering party
    When the user makes a request to retrieve the ordering-party section for the order with description Description1
...
Scenario: 2. Get an empty ordering party
    When the user makes a request to retrieve the ordering-party section for the order with description Description2
    Then a response with status code 200 is returned

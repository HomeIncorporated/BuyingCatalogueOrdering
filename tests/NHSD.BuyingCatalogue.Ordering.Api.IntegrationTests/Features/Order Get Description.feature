...
Background:
    Given Orders exist
        ...
        | OrderId 1 Description | 1             | 11/05/2020 | 11/05/2020  | 335392e4-4bb1-413b-9de5-36a85c9c0422 | 4af62b99-638c-4247-875e-965239cd0c48 |
        | OrderId 2 Description | 2             | 05/05/2020 | 09/05/2020  | a11a46f9-ce6f-448a-95c2-fde6e61c804a | 4af62b99-638c-4247-875e-965239cd0c48 |
    And the user is logged in with the Buyer role for organisation 4af62b99-638c-4247-875e-965239cd0c48

@5322
Scenario: 1. Get an orders description
    When the user makes a request to retrieve the order description section for order with description OrderId 1 Description
    Then a response with status code 200 is returned
    And the order description is returned
        | Description           |
        | OrderId 1 Description |

@5322
Scenario: 2. A non existent orderId returns not found
    When the user makes a request to retrieve the order description section with the ID -999
...
Scenario: 6. Service Failure
    ...
    When the user makes a request to retrieve the order description section with the ID 1

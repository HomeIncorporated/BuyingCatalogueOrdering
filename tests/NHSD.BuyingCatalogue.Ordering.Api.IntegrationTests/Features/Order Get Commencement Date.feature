...
Background:
    Given Orders exist
        | Description  | OrderStatusId | Created    | LastUpdatedBy                        | OrganisationId                       | CommencementDate |
        | Description1 | 1             | 11/05/2020 | 335392e4-4bb1-413b-9de5-36a85c9c0422 | 4af62b99-638c-4247-875e-965239cd0c48 | 01/01/2021       |
        | Description2 | 2             | 05/05/2020 | a11a46f9-ce6f-448a-95c2-fde6e61c804a | 4af62b99-638c-4247-875e-965239cd0c48 | 02/02/2021       |
    And the user is logged in with the Buyer role for organisation 4af62b99-638c-4247-875e-965239cd0c48
    
@4619
Scenario: 1. Get an orders commencement date
    When the user makes a request to retrieve the order commencement date section for the order with description Description1
...
Scenario: 2. A non existent orderId returns not found
    When the user makes a request to retrieve the order commencement date section with the ID -999

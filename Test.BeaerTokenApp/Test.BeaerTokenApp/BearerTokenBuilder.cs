...
namespace Test.BearerTokenApp
{
	public sealed class BearerTokenBuilder
    {
        ...
        private string _issuer = "http://host.docker.internal:8070/identity";
        private string _audience = "Organisation";
        ...
        //public async Task<string> BuildToken2()
        ////{
	       //// //var service = new DefaultTokenCreationService(new SystemClock(), new DefaultKeyMaterialService(), new IdentityServerOptions(), new NullLogger<DefaultTokenCreationService>())
	       //// //return await service.CreateTokenAsync(new Token());
